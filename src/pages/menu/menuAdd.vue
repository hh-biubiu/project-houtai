      ...
      <el-form :model="form">
        ...
        <el-form-item label="菜单图标" :label-width="width" v-if="form.type == 1">
          <el-select v-model="form.icon" placeholder="--请选择--">
            <el-option label="--请选择--" value="el-icon-star-on" disabled>
            </el-option>
        ...
        <el-form-item label="菜单地址" :label-width="width" v-else>
          <el-select v-model="form.url" placeholder="--请选择--">
            ...
            <el-option v-for = 'item in indexRouter' :key = 'item.path' :label="'/'+item.path" :value="item.name">
            </el-option>
        </el-select>
        </el-form-item>
...
import {reMenuAdd,reMenuInfo,reMenuEdit} from '../../util/request';
